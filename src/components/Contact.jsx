  ...
  return (
    <section id="contacto" className="py-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto border-t border-white/[0.08]">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-5 flex flex-col justify-between">
          <div>
            ...
            <p className="text-sm text-gray-400 font-light leading-relaxed mb-8">
              Disponível para novos projetos, mods personalizados para FiveM, aplicações web, bots Discord ou consultorias técnicas.
            </p>

            {/* Email card — clean solid container */}
            <div className="p-5 rounded-2xl bg-[#131313] border border-white/[0.06] mb-4">
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <button
                  onClick={copyEmail}
                  className="px-3.5 py-1.5 rounded-full bg-[#181818] hover:bg-[#222222] text-white text-xs font-medium transition-colors duration-150 shrink-0 flex items-center gap-1.5 border border-white/[0.06]"
                  title="Copiar e-mail"
                >
                  {copied ? (
                    <>
            ...
            <div className="p-5 rounded-2xl bg-[#131313] border border-white/[0.06] mb-8">
              <div className="flex items-center justify-between text-xs">
                ...
                <span className="text-gray-200 font-medium">{personal.location}</span>
              </div>
            </div>
          </div>

          {/* Social Platforms — Clean solid pill buttons */}
          <div>
            <span className="text-xs font-mono uppercase tracking-wider text-gray-500 block mb-3">
              Redes & Canais Oficiais
            </span>
        ...
        {/* Right Form (7 cols) — Clean solid container */}
          ...
          {sent ? (
            <div className="py-16 text-center">
              ...
              <p className="text-sm text-gray-400 max-w-xs mx-auto">
                Obrigado pelo contacto. Responderei diretamente para o teu e-mail.
              </p>
              <button
                onClick={() => setSent(false)}
                className="mt-6 px-4 py-2 rounded-xl bg-[#181818] hover:bg-[#222222] text-xs font-medium text-white transition-colors duration-150 border border-white/[0.06]"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  required
                  rows={4}
                  placeholder="Descreve o teu projeto ou objetivo..."
              ...
              <button
                type="submit"
                className="w-full py-3.5 rounded-xl bg-[#ff0000] hover:bg-[#e00000] text-white text-sm font-semibold transition-colors duration-150 shadow-[0_4px_16px_rgba(255,0,0,0.2)] flex items-center justify-center gap-2.5"
              >
